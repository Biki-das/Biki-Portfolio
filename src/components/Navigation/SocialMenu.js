  ...
  return (
    <MenuWrapper showOnMobile={false}>
      <div className="flex items-center justify-between gap-2 sm:gap-4 rounded-full py-1 px-3 sm:px-4 text-neutral-600 dark:text-neutral-400">
        <LinkWrapper href="https://github.com/Biki-das" label="github">
          <GithubIcon />
        </LinkWrapper>
        <LinkWrapper
          href="https://www.linkedin.com/in/biki-das-80a807182/"
          label="linkedin"
        >
          <LinkedInIcon />
        </LinkWrapper>
        <LinkWrapper href="https://x.com/biki__das" label="x">
          <XIcon />
        </LinkWrapper>
        <BottomStaticGlare />
      </div>

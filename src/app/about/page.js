        ...
        <div className="max-w-screen-sm w-full h-full flex flex-col gap-8 justify-start items-center relative">
          <div className="w-full flex justify-between items-center">
            <div className="flex justify-start items-center gap-4">
              ...
              <div className="flex flex-col justify-center items-start">
                ...
                <p className="text-neutral-500 text-sm">Frontend Engineer</p>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col justify-between items-center gap-2 text-neutral-700 dark:text-neutral-300 leading-7">
            <p className="w-full">
              ...
              Outside of programming for work, I work on Open source Projects.
            </p>
            <p className="w-full">
              My current tech stack is React, React-Native, Next.js, Tailwind
              CSS, and Framer Motion. Right now, I&#39;m working on generative
              SVGs, learning how to build GLSL shaders, and exploring ideas for
              my next 3D project.
            </p>
          </div>
          <MobileSocialLinks />
